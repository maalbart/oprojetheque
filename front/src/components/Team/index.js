  ...
  return (
    ...
    <div className="team">
      ...
      <div className="team-cards">
            <CardTeam className='team-cards-card' title="Célia" job="Scrum Master" picture={celiaPicture} description="Développeuse Fullstack spécialité Data/API" linkedin="https://www.linkedin.com/in/c%C3%A9lia-tocqueville-a2985121b/" github="https://github.com/celiatoc" />
            ...
            <CardTeam className='team-cards-card' title="Elias" job="Referent Technique" picture={eliasPicture} description="Développeur Fullstack spécialité Data/API" linkedin="https://www.linkedin.com/in/elias-gueye-084998225" github="https://github.com/Lucifer-Aeris" />
      </div>
    </div>
